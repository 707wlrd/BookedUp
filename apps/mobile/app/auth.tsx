    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        ...
        <View style={s.header}>
          ...
          <Text style={s.tagline}>Espace professionnel</Text>
        </View>
        ...
        <View style={s.card}>
          ...
          {sent ? (
            <View style={s.successBox}>
              ...
              <Pressable onPress={() => setSent(false)} style={s.backBtn}>
        ...
        <Pressable onPress={switchMode} style={s.switchRow}>
